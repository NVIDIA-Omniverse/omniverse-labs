...
_DEMOAPP = _HERE.parent
_REPO_ROOT = _DEMOAPP.parent
_DATA = _DEMOAPP / "usd"
_SSP_FILE = _DATA / "orbit_controller.ssp"
_USDA_FILE = _DATA / "ssp_orbit.usda"

# Ensure demoapp is on path for local imports
sys.path.insert(0, str(_DEMOAPP))
...
class TestUsdSchemaParsing:
    ...
    def parsed_schema(self):
        ...
        script = _DEMOAPP / "parse_fmi_schema.py"
