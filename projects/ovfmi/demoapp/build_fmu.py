...
All output goes to demoapp/usd/ next to the sample USD stages.

Usage:
    python3 demoapp/build_fmu.py

Requirements:
    - C++ compiler (g++ or clang++)
    - FMU source dirs in demoapp/fmu/ (each contains source + modelDescription.xml)
    - SSP source dirs in demoapp/ssp/
"""
...
FMU_SRC_DIR = DEMO_ROOT / "fmu"
SSP_SRC_DIR = DEMO_ROOT / "ssp"
DATA_DIR = DEMO_ROOT / "usd"
BUILD_DIR = DEMO_ROOT / "_build"
