...
from .common import OpenFileInEditor, SetClipboardText, SpawnNanousdview
...
class OpenLayerMenuItem(LayerStackContextMenuItem):
    ...
    def RunCommand(self):
        ...
        try:
            OpenFileInEditor(layerPath)
        except OSError as exc:
            print("Warning: Could not open layer in editor: %s" % exc)

#
# Opens the layer using nanousdview.
#
class UsdviewLayerMenuItem(LayerStackContextMenuItem):

    def GetText(self):
        return "Open Layer In nanousdview"
    ...
    def RunCommand(self):
        ...
        print("Spawning nanousdview %s" % layerPath)
        SpawnNanousdview(layerPath)
