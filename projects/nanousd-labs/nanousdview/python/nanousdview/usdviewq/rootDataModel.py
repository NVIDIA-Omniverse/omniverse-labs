...
class RootDataModel(QtCore.QObject):
    ...
    def computeWorldBound(self, prim):
        ...
        # nanousdview: relax the strict Usd.Prim isinstance check — nanousd's
        # _PseudoRootPrim is duck-compatible but doesn't share the class
        # hierarchy. Anything with GetPath() suffices here.
        if not (hasattr(prim, "GetPath") and hasattr(prim, "GetTypeName")):
