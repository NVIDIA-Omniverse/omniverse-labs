...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDomeLightTexturesVisible = QAction(MainWindow)
        self.actionDomeLightTexturesVisible.setObjectName(u"actionDomeLightTexturesVisible")
        ...
        self.actionSave_Viewer_Image = QAction(MainWindow)
        self.actionSave_Viewer_Image.setObjectName(u"actionSave_Viewer_Image")
        self.actionSave_Viewer_Image.setEnabled(True)
        self.actionCopy_Viewer_Image = QAction(MainWindow)
        self.actionCopy_Viewer_Image.setObjectName(u"actionCopy_Viewer_Image")
        ...
        self.showUsdValidation = QAction(MainWindow)
        self.showUsdValidation.setObjectName(u"showUsdValidation")
        self.showUsdValidation.setCheckable(False)
        ...
        self.actionAdjust_Free_Camera = QAction(MainWindow)
        self.actionAdjust_Free_Camera.setObjectName(u"actionAdjust_Free_Camera")
        ...
        self.actionShow_Prim_DisplayName = QAction(MainWindow)
        self.actionShow_Prim_DisplayName.setObjectName(u"actionShow_Prim_DisplayName")
        ...
        self.actionSave_State_To = QAction(MainWindow)
        self.actionSave_State_To.setObjectName(u"actionSave_State_To")
        ...
        self.actionSave_State_As_New_Config = QAction(MainWindow)
        self.actionSave_State_As_New_Config.setObjectName(u"actionSave_State_As_New_Config")
        self.actionFrame_Selected = QAction(MainWindow)
        self.actionFrame_Selected.setObjectName(u"actionFrame_Selected")
        self.showHydraSceneDebugger = QAction(MainWindow)
        self.showHydraSceneDebugger.setObjectName(u"showHydraSceneDebugger")
        ...
        self.renderFrame = QFrame(self.primStageSplitter)
        self.renderFrame.setObjectName(u"renderFrame")
        self.renderFrame.setLayoutDirection(Qt.LeftToRight)
        self.renderFrame.setFrameShape(QFrame.NoFrame)
        self.renderFrame.setFrameShadow(QFrame.Plain)
        self.renderFrame.setLineWidth(0)
        self.verticalLayout_5 = QVBoxLayout(self.renderFrame)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.renderMenuBar = QMenuBar(self.renderFrame)
        self.renderMenuBar.setObjectName(u"renderMenuBar")
        self.renderMenuBar.setLayoutDirection(Qt.LeftToRight)
        self.renderMenuBar.setNativeMenuBar(False)
        self.menuRender = QMenu(self.renderMenuBar)
        self.menuRender.setObjectName(u"menuRender")
        self.menuRendererSettings = QMenu(self.menuRender)
        self.menuRendererSettings.setObjectName(u"menuRendererSettings")
        self.menuRendererAovs = QMenu(self.menuRender)
        self.menuRendererAovs.setObjectName(u"menuRendererAovs")
        self.menuRendererCommands = QMenu(self.menuRender)
        self.menuRendererCommands.setObjectName(u"menuRendererCommands")
        self.menuViewer = QMenu(self.renderMenuBar)
        self.menuViewer.setObjectName(u"menuViewer")
        self.menuShading_Mode = QMenu(self.menuViewer)
        self.menuShading_Mode.setObjectName(u"menuShading_Mode")
        self.menuColorCorrection = QMenu(self.menuViewer)
        self.menuColorCorrection.setObjectName(u"menuColorCorrection")
        self.menuComplexity = QMenu(self.menuViewer)
        self.menuComplexity.setObjectName(u"menuComplexity")
        self.menuBBox = QMenu(self.menuViewer)
        self.menuBBox.setObjectName(u"menuBBox")
        self.menuDisplay = QMenu(self.menuViewer)
        self.menuDisplay.setObjectName(u"menuDisplay")
        self.menuHUD = QMenu(self.menuViewer)
        self.menuHUD.setObjectName(u"menuHUD")
        self.menuSelection_Highlighting = QMenu(self.menuViewer)
        ...
        self.menuBackground_Color = QMenu(self.menuViewer)
        self.menuBackground_Color.setObjectName(u"menuBackground_Color")
        self.menuCamera = QMenu(self.renderMenuBar)
        self.menuCamera.setObjectName(u"menuCamera")
        self.menuCameraSelect = QMenu(self.menuCamera)
        self.menuCameraSelect.setObjectName(u"menuCameraSelect")
        self.menuCameraSelect.setTearOffEnabled(True)
        self.menuCameraGuides = QMenu(self.menuCamera)
        self.menuCameraGuides.setObjectName(u"menuCameraGuides")
        self.menuCameraGuides.setTearOffEnabled(True)
        self.menuCamera_Masking = QMenu(self.menuCamera)
        self.menuCamera_Masking.setObjectName(u"menuCamera_Masking")
        self.menuCamera_Reticles = QMenu(self.menuCamera)
        self.menuCamera_Reticles.setObjectName(u"menuCamera_Reticles")
        self.menuPick = QMenu(self.renderMenuBar)
        self.menuPick.setObjectName(u"menuPick")
        self.menuLights = QMenu(self.renderMenuBar)
        self.menuLights.setObjectName(u"menuLights")

        self.verticalLayout_5.addWidget(self.renderMenuBar)

        self.glFrame = QFrame(self.renderFrame)
        self.glFrame.setObjectName(u"glFrame")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.glFrame.sizePolicy().hasHeightForWidth())
        self.glFrame.setSizePolicy(sizePolicy3)
        ...
        self.primStageSplitter.addWidget(self.renderFrame)
        ...
        sizePolicy4.setHeightForWidth(self.propertyLegendQButton.sizePolicy().hasHeightForWidth())
        self.propertyLegendQButton.setSizePolicy(sizePolicy4)
        ...
        self.metadataView.horizontalHeader().setProperty(u"showSortIndicator", False)
        ...
        if (self.layerStackView.columnCount() < 4):
        ...
        self.layerStackView.setHorizontalHeaderItem(3, __qtablewidgetitem5)
        ...
        self.layerStackView.horizontalHeader().setProperty(u"showSortIndicator", False)
        ...
        sizePolicy5.setHeightForWidth(self.stageBegin.sizePolicy().hasHeightForWidth())
        self.stageBegin.setSizePolicy(sizePolicy5)
        ...
        self.verticalSpacer = QSpacerItem(20, 7, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Maximum)
        ...
        sizePolicy5.setHeightForWidth(self.rangeBegin.sizePolicy().hasHeightForWidth())
        self.rangeBegin.setSizePolicy(sizePolicy5)
        ...
        self.verticalSpacer_2 = QSpacerItem(20, 7, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Maximum)
        ...
        self.verticalSpacer_3 = QSpacerItem(10, 7, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Maximum)
        ...
        sizePolicy6.setHeightForWidth(self.rangeEnd.sizePolicy().hasHeightForWidth())
        self.rangeEnd.setSizePolicy(sizePolicy6)
        ...
        self.verticalSpacer_4 = QSpacerItem(20, 7, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Maximum)
        ...
        sizePolicy5.setHeightForWidth(self.stageEnd.sizePolicy().hasHeightForWidth())
        self.stageEnd.setSizePolicy(sizePolicy5)
        ...
        self.horizontalSpacer_3 = QSpacerItem(15, 20, QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Minimum)
        ...
        sizePolicy4.setHeightForWidth(self.frameLabel.sizePolicy().hasHeightForWidth())
        self.frameLabel.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.frameField.sizePolicy().hasHeightForWidth())
        self.frameField.setSizePolicy(sizePolicy4)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1145, 20))
        self.menubar.setMinimumSize(QSize(0, 0))
        self.menuFile = QMenu(self.menubar)
        self.menuFile.setObjectName(u"menuFile")
        self.menuSave_State_As = QMenu(self.menuFile)
        self.menuSave_State_As.setObjectName(u"menuSave_State_As")
        self.menuLoad_New_State = QMenu(self.menuFile)
        self.menuLoad_New_State.setObjectName(u"menuLoad_New_State")
        ...
        self.menuWindow.addAction(self.showUsdValidation)
        self.menuWindow.addAction(self.showDebugFlags)
        self.menuWindow.addAction(self.showHydraSceneDebugger)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setProperty(u"comment", QCoreApplication.translate("MainWindow", u"\n"
...
"  ", None))
...
#if QT_CONFIG(shortcut)
        self.actionReopen_Stage.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+R", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.actionAmbient_Only.setText(QCoreApplication.translate("MainWindow", u"Enable Default Camera Light", None))
        self.actionDomeLight.setText(QCoreApplication.translate("MainWindow", u"Enable Default Dome Light", None))
        self.actionDomeLightTexturesVisible.setText(QCoreApplication.translate("MainWindow", u"Show Dome Light Textures", None))
...
#endif // QT_CONFIG(tooltip)
        self.actionSave_Viewer_Image.setText(QCoreApplication.translate("MainWindow", u"Save Viewer Image...", None))
        self.actionSave_Viewer_Image.setIconText(QCoreApplication.translate("MainWindow", u"Save Viewer Image...", None))
#if QT_CONFIG(tooltip)
        self.actionSave_Viewer_Image.setToolTip(QCoreApplication.translate("MainWindow", u"Saves the viewer render of the current frame", None))
#endif // QT_CONFIG(tooltip)
        self.actionCopy_Viewer_Image.setText(QCoreApplication.translate("MainWindow", u"Copy Viewer Image", None))
        self.actionCopy_Viewer_Image.setIconText(QCoreApplication.translate("MainWindow", u"Copy Viewer Image", None))
#if QT_CONFIG(tooltip)
        self.actionCopy_Viewer_Image.setToolTip(QCoreApplication.translate("MainWindow", u"Copies the viewer render of the current frame to the clipboard", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
        self.showUsdValidation.setText(QCoreApplication.translate("MainWindow", u"USD Validation", None))
#if QT_CONFIG(tooltip)
        self.showUsdValidation.setToolTip(QCoreApplication.translate("MainWindow", u"Show USD Validation Widget", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.showUsdValidation.setShortcut(QCoreApplication.translate("MainWindow", u"V", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.actionAdjust_Free_Camera.setText(QCoreApplication.translate("MainWindow", u"Free Camera Settings...", None))
        ...
        self.actionShow_Prim_DisplayName.setText(QCoreApplication.translate("MainWindow", u"Use Display Name (Prims)", None))
        self.actionPick_Prims.setText(QCoreApplication.translate("MainWindow", u"Select Prims", None))
        self.actionPick_Models.setText(QCoreApplication.translate("MainWindow", u"Select Models", None))
        self.actionPick_Instances.setText(QCoreApplication.translate("MainWindow", u"Select Instances", None))
        self.actionPick_Prototypes.setText(QCoreApplication.translate("MainWindow", u"Select Prototypes", None))
        self.actionToggle_Viewer_Mode.setText(QCoreApplication.translate("MainWindow", u"Toggle Viewer-Only Mode", None))
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        self.actionRollover_Prim_Info.setText(QCoreApplication.translate("MainWindow", u"Show Rollover Prim Info", None))
#if QT_CONFIG(shortcut)
        ...
        self.actionAdjust_Default_Material.setText(QCoreApplication.translate("MainWindow", u"Default Material Settings...", None))
        ...
        self.actionSave_State_To.setText(QCoreApplication.translate("MainWindow", u"Save State To ", None))
        ...
        self.actionSave_State_As_New_Config.setText(QCoreApplication.translate("MainWindow", u"Save State As New Config...", None))
        self.actionFrame_Selected.setText(QCoreApplication.translate("MainWindow", u"Frame Selected", None))
#if QT_CONFIG(shortcut)
        self.actionFrame_Selected.setShortcut(QCoreApplication.translate("MainWindow", u"F", None))
#endif // QT_CONFIG(shortcut)
        self.showHydraSceneDebugger.setText(QCoreApplication.translate("MainWindow", u"Hydra Scene Debugger", None))
        ...
        ___qtreewidgetitem.setText(3, QCoreApplication.translate("MainWindow", u"Guides", None));
        ...
        self.menuRender.setTitle(QCoreApplication.translate("MainWindow", u"Renderer", None))
        ...
        self.menuRendererCommands.setTitle(QCoreApplication.translate("MainWindow", u"Hydra Commands", None))
        self.menuViewer.setTitle(QCoreApplication.translate("MainWindow", u"Display", None))
        ...
        self.menuCameraSelect.setTitle(QCoreApplication.translate("MainWindow", u"Select Camera", None))
        ...
        self.menuPick.setTitle(QCoreApplication.translate("MainWindow", u"Select", None))
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Offset , Scale", None));
        ...
        ___qtablewidgetitem5 = self.layerStackView.horizontalHeaderItem(3)
        ...
        self.menuSave_State_As.setTitle(QCoreApplication.translate("MainWindow", u"Save State As", None))
        self.menuLoad_New_State.setTitle(QCoreApplication.translate("MainWindow", u"Reopen With State", None))
