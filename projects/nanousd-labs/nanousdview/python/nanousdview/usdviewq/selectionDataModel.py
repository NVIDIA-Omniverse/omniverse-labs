...
class SelectionDataModel(QtCore.QObject):
    ...
    def getFocusPrim(self):
        ...
        if stage is None:
            return None
        return stage.GetPrimAtPath(self.getFocusPrimPath())
    ...
    def getPrims(self):
        ...
        if stage is None:
            return []
        return [stage.GetPrimAtPath(path) for path in self.getPrimPaths()]
    ...
    def getLCDPrims(self):
        ...
        if stage is None:
            return []
        return [stage.GetPrimAtPath(path) for path in self.getLCDPaths()]
    ...
    def getPrimInstances(self):
        ...
        if stage is None:
            return OrderedDict()
        return OrderedDict(
            (stage.GetPrimAtPath(path), instance)
