...
class ListRoutesResponse(_message.Message):
    __slots__ = ("items",)
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[Route]
    def __init__(self, items: _Optional[_Iterable[_Union[Route, _Mapping]]] = ...) -> None: ...
...
class Route(_message.Message):
    __slots__ = ("wildcard_pattern",)
    WILDCARD_PATTERN_FIELD_NUMBER: _ClassVar[int]
    wildcard_pattern: str
    def __init__(self, wildcard_pattern: _Optional[str] = ...) -> None: ...
